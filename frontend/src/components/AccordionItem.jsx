...
function AccordionItem({ header, text }) {
    ...
    return (
        <div className="mb-8 w-full rounded-lg bg-gray-100 border border-teal-300 p-4 shadow-[0px_20px_95px_0px_rgba(201,203,204,0.30)] sm:p-8 lg:px-6 xl:px-8">
            <button
